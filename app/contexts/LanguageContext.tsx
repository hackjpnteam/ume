...
const translations = {
  ja: {
    ...
    'hero.description2':
      '塩分濃度と熟成期間を徹底管理し、梅本来の酸味と旨味を引き出します。天日干しでは「塩の花」と呼ばれる結晶が生まれ、旨味の証となります。',
  ...
  en: {
    ...
    'hero.description1':
      'Our umeboshi are carefully crafted using selected Kishu Nanko plums with traditional methods.',
    'hero.description2':
      'We meticulously manage salt concentration and aging periods to bring out the natural acidity and umami of plums. The sun-drying process creates "shio no hana" (salt flowers), crystals that are proof of concentrated umami.',
    ...
    'features.subtitle':
      'Traditional methods combined with modern quality control create our exceptional umeboshi',
