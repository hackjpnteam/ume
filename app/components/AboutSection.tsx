...
export default function AboutSection() {
  return (
    <section
      id="about"
      className="py-20 bg-gradient-to-br from-emerald-50 via-green-50 to-teal-50 relative overflow-hidden"
    >
      {/* 背景装飾 */}
      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">中峰農園について</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">伝統と革新の融合</h3>
              <div className="space-y-4 text-gray-700 leading-relaxed">
                ...
                <p>自然の恵みを最大限に活かした、こだわりの梅干しをぜひご賞味ください。</p>
              </div>
