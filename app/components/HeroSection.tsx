...
export default function HeroSection() {
  return (
    <section className="bg-gradient-to-br from-yellow-300 to-yellow-500 relative overflow-hidden">
      {/* 簡単な装飾 */}
      <div className="absolute top-1/4 left-1/2 transform -translate-x-1/2 text-white opacity-10" style={{fontSize: '36rem'}}>🌸</div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              <div>
                <p className="text-red-800 text-sm font-medium mb-4 tracking-wider">
                  Kodawari
                </p>
                <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 leading-tight mb-6">
                  紀州・中峰農園の<br className="sm:hidden" />梅干し
                </h1>
              </div>

              <div className="text-gray-800 leading-loose space-y-4">
                <p className="text-lg">
                  厳選された紀州南高梅、<br className="sm:hidden" />伝統の技で磨き上げ。
                </p>
                <p className="text-lg">
                  天日干しで浮かぶ「塩の花」が<br className="sm:hidden" />旨味の証。
                </p>
                <p className="text-lg font-medium">
                  ようやく辿り着いた、<br className="sm:hidden" />ここにしかない梅干し。
                </p>
              </div>
